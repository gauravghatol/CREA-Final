...
import CharterOfDemand from './pages/CharterofDemand'
...
function AnimatedRoutes() {
  ...
  <Route path="/charter-of-demand" element={<RequireAuth><PageTransition><CharterOfDemand /></PageTransition></RequireAuth>} />
