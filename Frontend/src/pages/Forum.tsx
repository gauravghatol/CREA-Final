      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200">
        <div className="px-5 py-4 bg-blue-50 border-b border-blue-100">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-semibold text-[var(--primary)]">Discussion Forum</h1>
              <p className="text-xs text-gray-600">Connect, collaborate, and share knowledge</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-white rounded-lg p-5 border border-gray-200 shadow-sm">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-xs font-medium text-[var(--secondary)] mb-1">Total Topics</p>
        ...
        <div className="bg-white rounded-lg p-5 border border-gray-200 shadow-sm">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-xs font-medium text-[var(--secondary)] mb-1">Active Discussions</p>
              <p className="text-2xl font-bold text-[var(--primary)]">{topics.filter(t => t.replies > 0).length}</p>
            </div>
        ...
        <div className="bg-white rounded-lg p-5 border border-gray-200 shadow-sm">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-xs font-medium text-[var(--secondary)] mb-1">Total Replies</p>
              <p className="text-2xl font-bold text-[var(--primary)]">{topics.reduce((sum, t) => sum + t.replies, 0)}</p>
            </div>
        ...
        <div className="lg:col-span-1 space-y-4">
          <div className="bg-white rounded-lg shadow-sm border p-4">
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-base font-bold text-[var(--primary)]">Discussion Topics</h2>
        ...
        <div className="lg:col-span-2">
          {!active ? (
            <div className="bg-white rounded-lg border-2 border-dashed border-gray-300 p-12 text-center">
              <div className="inline-flex p-4 bg-[var(--primary)]/10 rounded-lg mb-4">
                <svg className="w-10 h-10 text-[var(--primary)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" />
                </svg>
              </div>
              <h3 className="text-base font-semibold text-gray-900 mb-2">Select a Topic</h3>
              <p className="text-sm text-gray-600">Choose a discussion topic from the list to view and participate in the conversation.</p>
            </div>
          ) : (
                ...
                <div className="px-5 py-4 bg-blue-50 border-b border-blue-100">
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      <h3 className="text-lg font-bold text-[var(--primary)] mb-2">{active.title}</h3>
                    ...
                    <div className="bg-[var(--primary)]/10 rounded-lg px-3 py-2">
                      <div className="text-xs text-gray-600">Replies</div>
                      <div className="text-xl font-bold text-[var(--primary)]">{active.replies}</div>
                    </div>
                  </div>
                </div>
              </motion.div>
